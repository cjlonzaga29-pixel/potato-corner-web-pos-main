 ...
 * active-sessions.production.spec.ts, and two-factor.production.spec.ts.
...
export default defineConfig({
  testDir: '.',
  testMatch: /(expenses|branch-selector|notifications-page|payments-gcash-qr|monitoring-page|inventory-analytics-page|active-sessions|two-factor)\.production\.spec\.ts/,
