...
/**
 * Super admin dashboard section — low/critical stock items. Scoped to the
 * selected branch via the branch alerts endpoint (has real thresholds); when
 * no branch is selected, derives the same low/critical set from the
 * all-branch valuation rollup (InventoryRollupCard's data source) since
 * there is no dedicated cross-branch alerts endpoint.
 */
