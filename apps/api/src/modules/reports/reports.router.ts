...
function toBoundaryDate(value: string | undefined, boundary: 'start' | 'end'): Date | undefined {
  return value ? resolveDateRangeBoundary(value, boundary) : undefined;
}
...
realtimeRoute('/inventory-value-summary', (f, id, role) => reportsService.getInventoryValueSummaryReport(f, id, role));
