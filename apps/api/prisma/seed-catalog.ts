...
const PRODUCTS: ProductSeed[] = [
  {
    ...
    category: 'Fries',
    variants: [
      { sizeLabel: 'Small', basePrice: 42, maxFlavors: 1, withFlavors: true },
      { sizeLabel: 'Medium', basePrice: 62, maxFlavors: 1, withFlavors: true },
      { sizeLabel: 'Large', basePrice: 82, maxFlavors: 1, withFlavors: true },
      { sizeLabel: 'Mega', basePrice: 130, maxFlavors: 2, withFlavors: true },
      { sizeLabel: 'Giga', basePrice: 180, maxFlavors: 2, withFlavors: true },
  ...
  },
  {
    ...
    category: 'Fries',
    variants: [
      { sizeLabel: 'Regular', basePrice: 75, maxFlavors: 1, withFlavors: false },
      { sizeLabel: 'Large', basePrice: 135, maxFlavors: 1, withFlavors: false },
    ],
  },
  {
    ...
    category: 'Chicken',
    variants: [
      { sizeLabel: 'Small', basePrice: 79, maxFlavors: 1, withFlavors: false },
      { sizeLabel: 'Regular', basePrice: 139, maxFlavors: 1, withFlavors: false },
      { sizeLabel: 'Large', basePrice: 199, maxFlavors: 1, withFlavors: false },
    ],
  },
  {
    name: 'Mix & Max',
    category: 'Combos',
    variants: [
      { sizeLabel: 'Regular', basePrice: 99, maxFlavors: 0, withFlavors: false },
      { sizeLabel: 'Large', basePrice: 179, maxFlavors: 0, withFlavors: false },
      { sizeLabel: 'Family', basePrice: 259, maxFlavors: 0, withFlavors: false },
    ],
  },
  {
    name: 'Drinks',
