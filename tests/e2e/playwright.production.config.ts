 ...
 * notifications-page.production.spec.ts, and payments-gcash-qr.production.spec.ts.
...
export default defineConfig({
  testDir: '.',
  testMatch: /(expenses|branch-selector|notifications-page|payments-gcash-qr)\.production\.spec\.ts/,
