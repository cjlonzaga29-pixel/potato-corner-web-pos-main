 ...
 * a transient Socket.io-only push, distinct from the persisted Notification
 * module (apps/api/src/modules/notifications/), which has its own DB-backed
 * rows and REST endpoints. This reuses the Socket.io room infrastructure
 * already wired up in Phase 4 instead of going through that module. A no-op
