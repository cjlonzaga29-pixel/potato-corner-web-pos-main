...
/**
 * GET /api/attendance/branch/:branchId requires branchGuard — a supervisor
 * with multiple branches switches via the sidebar's BranchSelector
 * (useBranchStore), same pattern as /supervisor/cash and /supervisor/inventory.
 */
